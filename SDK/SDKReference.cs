...
namespace SDK
{
    public static class NativeMethods
    {
        ...
        //  SDK Path
        const string SdkPath = @"dlls\swedll32.dll";
        ...
        [DllImport(SdkPath, EntryPoint = "_swe_set_ephe_path@4")]
        public static extern void swe_set_ephe_path(string path);

        [DllImport(SdkPath, EntryPoint = "_swe_close@0")]
        public static extern void swe_close();

        [DllImport(SdkPath, EntryPoint = "_swe_version@4")]
        public static extern string swe_version(string svers);

        [DllImport(SdkPath, EntryPoint = "_swe_julday@24")]
        ...
        [DllImport(SdkPath, EntryPoint = "_swe_house_pos@36")]
        ...
        [DllImport(SdkPath, EntryPoint = "_swe_sidtime@8")]
        public static extern double swe_sidtime(double tjd_ut);

        [DllImport(SdkPath, EntryPoint = "_swe_sidtime0@24")]
        ...
        [DllImport(SdkPath, EntryPoint = "_swe_get_planet_name@8")]
        ...
        [DllImport(SdkPath, EntryPoint = "_swe_houses_ex@40")]
        ...
        [DllImport(SdkPath, EntryPoint = "_swe_houses@36")]
        ...
        [DllImport(SdkPath, EntryPoint = "_swe_utc_time_zone@60")]
        ...
        [DllImport(SdkPath, EntryPoint = "_swe_set_sid_mode@20")]
        ...
        [DllImport(SdkPath, EntryPoint = "_swe_rise_trans@52")]
